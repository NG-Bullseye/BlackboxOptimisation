...
class GaussianProcessOptimizer:
    def __init__(self, function, quantization_factor=2, n_iterations=20, interval=10):
        self.f = function
    ...
    def predict(self, X_test):
        ...
        mu_star = K_star @ np.linalg.inv(K) @ self.Y_train[:, None]
...
if __name__ == '__main__':
    ...
    optimizer = GaussianProcessOptimizer(function_to_optimize)
    optimizer.optimize()